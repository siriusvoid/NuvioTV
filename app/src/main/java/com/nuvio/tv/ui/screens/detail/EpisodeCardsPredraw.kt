...
/** Draws the cards the first jump reveals into an unseen layer, so GPU first-draw work happens earlier. */
@Composable
internal fun EpisodeCardsPredraw(
    ...
    Column(
        modifier = modifier
            ...
            // Alpha 0 still renders offscreen; two by two stays under the GPU texture size limit.
            .graphicsLayer {
                alpha = 0f
