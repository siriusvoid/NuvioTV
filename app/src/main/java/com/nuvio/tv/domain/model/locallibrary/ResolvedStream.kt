...
data class ResolvedStream(
    ...
    /** "content" or "file" — used to route the right ExoPlayer DataSource. */
    val scheme: String,
...
/** An external subtitle from a local source, passed to ExoPlayer as a SubtitleConfiguration. */
@Immutable
data class ExternalSubtitleFile(
    ...
    enum class Source { LOCAL_SIDECAR }
}
