...
data class WebDavSource(
    ...
    /** Previous root listing size; a much shorter listing is treated as truncated, not a mass deletion. */
...
data class WebDavMatch(
    ...
    /** Name and artwork from the metadata addon, matching the details page; search values are the fallback. */
    val metaName: String? = null,
    val metaPoster: String? = null,
    val season: Int? = null,
    /** Added to parsed episode numbers: zero within a cour, a shift for absolute-numbered long-runners. */
