...
/** Hrefs arrive percent-encoded, absolute or relative: decode once, re-encode on use. */
internal object WebDavUrl {
    ...
    fun buildUrl(baseUrl: String, vararg segments: String): String {
        ...
        // Collections end with a slash; otherwise servers redirect and a PROPFIND can lose its body.
    ...
    /** RFC 3986 encoding; not URLEncoder, whose `+` for spaces breaks a WebDAV href. */
...
/** HTTP-date or ISO-8601 to epoch seconds; null only sorts that folder last. */
