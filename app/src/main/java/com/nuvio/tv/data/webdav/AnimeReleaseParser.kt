...
/** Parses fansub-style release names; season words stay in titles, since databases list them as entries. */
internal object AnimeReleaseParser {
    ...
    fun parse(
        ...
        // Scene names use dots ("Laid-Back.Camp.S02"), so dots become spaces before S/E matching.
        ...
        // Some groups bracket the episode ("Flying_Witch_[08]"), which tag stripping removes.
    ...
    private fun cleanTitle(value: String): String {
        // "Air (2005) + Air in Summer": the first part is the show; the rest arrives as season 0.
    ...
    /** Lowercase unaccented words for scoring and cache keys; databases disagree on accents and possessives. */
    ...
    fun similarity(left: String, right: String): Float {
        ...
        // Databases hyphenate differently ("Natsu-iro" vs "Natsuiro"), so letters are compared too.
