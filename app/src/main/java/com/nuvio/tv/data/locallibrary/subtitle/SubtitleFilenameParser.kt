...
/** Reads language, forced and SDH flags from sidecar names like `Movie.en.forced.srt`. */
object SubtitleFilenameParser {
    ...
    /** Fallback comparing parsed title, year and S/E, for release-named videos with cleanly named subtitles. */
    ...
    /** Tokens after the title that may hold language/forced/SDH, walked from the end when names differ. */
    ...
    /** Trailing tokens first; split codes like ["pt", "BR"] are joined. */
